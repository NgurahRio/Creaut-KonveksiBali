...
export const testimonials = [
  { name: "exsos XII 9", role: "2 bulan lalu", text: "Konveksi Advish benar-benar memberikan pengalaman yang sangat memuaskan. Kualitas jahitannya rapi dan detail, bahan yang digunakan juga terasa nyaman dan tidak murahan. Pelayanan mereka sangat ramah dan responsif, sehingga komunikasi selama proses pemesanan berjalan lancar tanpa kendala.", rating: 5, image: "/assets/advicekonveksitestimonial1.png" },
  { name: "Putu Chandra Risca Dinata", role: "4 bulan lalu", text: "Konveksi ini oke sih. Dari bahan sampai hasil akhir sesuai sama yang diharapkan. Adminnya responsif dan enak diajak komunikasi. Worth it buat langganan.", rating: 5, image: "/assets/advicekonveksitestimonial2.png" },
  { name: "Ni Luh Komang Triayu Laksmi Dewi", role: "2 bulan lalu", text: "pernah skeptis sama konveksi, tapi konveksi yang satu ini berhasil matahin stigma ku itu karena dari proses awal - akhir semuanya dibantu dengan jelas dan jujur! setiap ada problem pstii di kabari dan dari awal selalu di make sure supaya ekspektasi ku dan mereka sama. dan hasil produksi ga kaleng”,bener bener sesuai sama ekspektasi🥹 terharu bgt, semoga owner nya yg buat nih konveksi masuk surga ya kak!", rating: 5, image: "/assets/advicekonveksitestimonial3.png" },
  { name: "Cindy Oktacia", role: "4 bulan lalu", text: "pelayanannyaa bagus banget apa lagi hasil sablonnya ga pernah mengecewakan, selalu memuaskaannn, TOP BANGET ⭐️⭐️⭐️⭐️", rating: 5, image: "/assets/advicekonveksitestimonial4.png" },
  { name: "helmi kuswandi", role: "2 bulan lalu", text: "Yang saya notice waktu order di Advish Konveksi tuh mereka gak vuma bilang \"bisa\",tapi juga jelasin dari sisi produksi. Bahkan kemungkinan hasil yang kurang maksimal juga dikasih tau dari awal. Jadi kita sebagai customer malah lebih kebayang hasil akhirnya bakal kayak gimana.", rating: 5, image: "/assets/advicekonveksitestimonial5.png" },
  { name: "I GUSTI AYU NGURAH ANGGIA PRADNYANI", role: "sebulan lalu", text: "Kualitas bajunya bagus dan ramah dikantong juga nih\nyuk dicoba gais dijamin puas sama hasilnya", rating: 5, image: "/assets/advicekonveksitestimonial6.png" },
  { name: "Surya Wirakusumah", role: "2 bulan lalu", text: "Menurutku yang bikin beda Advish tuh mereka jelasin proses nya. Bahkan worst case di produksi juga disampaikan. Jadi kita sebagai customers ngerasa lebih dihargai dan gak dibikin terlalu berharap tinggi doang.", rating: 5, image: "/assets/advicekonveksitestimonial7.png" },
  { name: "Ni komang Luh suandewi", role: "2 bulan lalu", text: "Salah satu hal yang menurutku beda dari advish mereka transparan banget. Dari bahan proses produksi sampai kemungkinan terburuknya ,juga di jelasin jadi pas barang jadi itu gak kaget malah sesuai ekspektasi.", rating: 5, image: "/assets/advicekonveksitestimonial8.png" },
  { name: "Made Vita Maharani", role: "4 bulan lalu", text: "keren banget kualitasnya gausah diragukan lagii bahannya selalu premium selalu memuaskan", rating: 5, image: "/assets/advicekonveksitestimonial9.png" },
  { name: "Meybella V. Saputra", role: "sebulan lalu", text: "Pelayanannya bagus banget, sangat informatif dan satset. Kualitas gak usah diraguin lagi deh. Recommended!", rating: 5, image: "/assets/advicekonveksitestimonial10.png" },
  { name: "Hendra ije", role: "2 bulan lalu", text: "Enaknya bikin di Advish Konveksi tuh mereka ngasih insight dari sisi produksi juga. Jadi kita gak cuma order doang, tapi dikasih gambaran realistis soal hasil akhirnya. Jarang sih Nemu konveksi yang kayak gitu.", rating: 5, image: "/assets/advicekonveksitestimonial11.png" },
  { name: "A.A.Ngurah Agung Kusuma Putra", role: "5 bulan lalu", text: "Pemesanan baju disini sangat baik, selain dari hasil bajunya yang bagus, pelayanannya juga sangat ramah", rating: 5, image: "/assets/advicekonveksitestimonial12.png" },
  { name: "Enjang Suhadma", role: "2 bulan lalu", text: "Respect sih sama cara Advish handle order. mereka dari awal udah jelasin kemungkinan terbaik sampai kemungkinan kurang idealnya. Buatku itu malah bikin lebih trust sama hasil akhirnya.", rating: 5, image: "/assets/advicekonveksitestimonial13.png" },
  { name: "Gusti Ayu Jacinda Mewiana Putri", role: "5 bulan lalu", text: "Kualitas bintang 5 ⭐ hasil dari jahitannya sangat rapiii dan bahannya juga bagus, untuk harganya juga ramah di kantong, bestt dehh pokoknyaa", rating: 5, image: "/assets/advicekonveksitestimonial14.png" },
  { name: "Feby Amanda Sukmawati", role: "4 bulan lalu", text: "selama organisasi yang saya ikuti selalu membuat baju di advish konveksi karena baju disana bahan nya bagus, adem dan juga stylelish.", rating: 5, image: "/assets/advicekonveksitestimonial15.png" },
  { name: "Putu Dinda Priyah Putri", role: "5 bulan lalu", text: "hasil jahitannya rapi dan bahannya juga bagus,, untuk soal harga sangat amat terjangkau dan kualitass bintang 5❤️", rating: 5, image: "/assets/advicekonveksitestimonial16.png" },
  { name: "Ni Komang Kharina Gayatri", role: "6 bulan lalu", text: "Sangat senang bekerja sama dengan Advish Konveksi🤩🤩🤩, hampir setahun bekerja sama dan sudah sangat banyak juga pesenan kami yang ada saja requestnya itu dibuatkan oleh konveksi dengan baik dan teliti. Teruntuk owner Advish Konveksi kak Wibawa dan kak Caca kami ucapkan terima kasih banyak atas semua dedikasinya karena setiap kendala yang ada sudah diselesaikan dan selalu dikomunikasikan dengan baik dan saya mewakili Himatika Udayana mengucapkan maaf jika terdapat hal yang kurang berkenan selama hampir setahun ini💐🙂‍↕️👐🏻. Buat kalian yang mau lihat hasil-hasil karya Advish Konveksi bisa langsung cek Instagram @himatika.udayana periode 2025🔥🔥🔥🤩🤩👏🏻👏🏻👏🏻", rating: 5, image: "/assets/advicekonveksitestimonial17.png" }
];
